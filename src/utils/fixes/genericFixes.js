 ...
 * 
 * Pre-processing fixes that apply to any JavaScript code,
...
export function applyGenericFixes(code) {
  ...
  // Fix multiple semicolons (;;; or more → ;)
  ...
  // Reduce multiple blank lines (4+ consecutive) to max 2
  ...
  // Simplify boolean comparisons (conservative approach)
